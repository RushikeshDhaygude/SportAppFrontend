        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                buildTeamInfo(team1LogoPath, team1Name),
                SizedBox(width: 8), // Adjust this width to bring logos closer
                Text('vs', style: TextStyle(fontWeight: FontWeight.bold)),
                SizedBox(width: 8), // Adjust this width to bring logos closer
                buildTeamInfo(team2LogoPath, team2Name),
              ],
            ...
            Divider(color: Colors.grey[300]),
            buildInfoRow(Icons.location_on, 'Location', match['event']['location']),
            buildInfoRow(Icons.calendar_today, 'Date', date),
            buildInfoRow(Icons.access_time, 'Time', time),
            if (isAdmin)
              Row(
  ...
  Widget buildTeamInfo(String logoPath, String teamName) {
    return Column(
      children: [
        ...
        SizedBox(height: 4), // Adjust this height to bring the text closer to the logo
        Text(
          teamName,
          style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold), // Bold team name
        ),
      ],
    );
  }
